...
df = pd.read_csv("C:/Users/Carsen Rae Helms/OneDrive/Desktop from Surface Pro/Portfolio/Global MH Disorder Trends/top3_depression_trend.csv")
...
plt.tight_layout()
plt.savefig("top3_depression_chart.png", dpi=300)
plt.show()
